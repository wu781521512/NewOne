...
public class HotFragment extends Fragment {
    ...
    private void initData() {
        HttpRequest httpRequest = new HttpRequest(getContext(), HttpUrl.JOURNEYHOT,new HotHandler(getContext()), HandlerBack.JOURNEYHOT);
    ...
    class HotHandler extends HandleUtil {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == HandlerBack.JOURNEYHOT) {
