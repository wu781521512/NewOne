...
public class NewFragment extends Fragment {
    ...
    private void initData() {
        HttpRequest httpRequest = new HttpRequest(getContext(), HttpUrl.JOURNEYNEW,new FragmentHandler(getContext()), HandlerBack.JOURNEYNEW);
        httpRequest.startRequest();
    }

    class FragmentHandler extends HandleUtil {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == HandlerBack.JOURNEYNEW) {
